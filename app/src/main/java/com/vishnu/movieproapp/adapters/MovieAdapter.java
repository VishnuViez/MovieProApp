package com.vishnu.movieproapp.adapters;
...
import com.vishnu.movieproapp.databinding.MovieListItemLayoutBinding;
import com.vishnu.movieproapp.model.Movie;
import com.vishnu.movieproapp.view.MovieActivity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        MovieListItemLayoutBinding movieListItemLayoutBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.movie_list_item_layout, parent, false);
